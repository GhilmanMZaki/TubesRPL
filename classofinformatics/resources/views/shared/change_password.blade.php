                ...
                <div class="body justify-content-around">
                    ...
                    <form class="form-auth-small my-auto" action="{{ route('update-password') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control round" id="old_password" name="old_password"
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control round" id="password_confirmation"
                        ...
                        <a href="{{ route('dashboard') }}" type="button"
                            class="btn bg-blue-2 text-white btn-round btn-block">Kembali ke Dashboard</a>
                    </form>
                    <div class="pattern">
                        <span class="red"></span>
