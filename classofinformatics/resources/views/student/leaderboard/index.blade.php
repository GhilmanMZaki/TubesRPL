...
@section('content')
    <div class="block-header">
        <h4 class="text-white my-sm-3 my-2 text-capitalize">leaderboard {{ $schoolDetail['name'] }} Semester
            {{ $user->semester }}</h4>
            ...
            <div class="col-md-4 mt-2 mb-3">
                <div class="d-flex flex-column m-auto rounded bg-white shadow">
                    ...
                    <div class="bg-blur-grey pt-3 pb-0 px-5 d-flex justify-content-between align-items-center">
                        <div class="pl-2">
                            <div class="d-flex align-items-center justify-content-center w35 bg-blue-2 rounded cursor-pointer ml-2"
                                data-toggle="tooltip" data-placement="top" title="xp"><img
                                    src="{{ asset('assets/images/xp.svg') }}"></div>
                            <p class="text-dark text-center pt-2 pl-2">{{ $experience->experience_point }}</p>
                        </div>
                        <div class="pr-2">
                            <div class="d-flex align-items-center justify-content-center w35 bg-blue-2 rounded cursor-pointer ml-2"
                                data-toggle="tooltip" data-placement="top" title="level"><img
                                    src="{{ asset('assets/images/level.svg') }}"></div>
