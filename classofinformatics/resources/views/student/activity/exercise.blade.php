        ...
        <div class="m-auto pt-5 result m-auto">
            <div class="p-4 bg-white shadow-sm rounded">
                ...
                <div class="d-flex mt-3 align-items-center">
                    <div class="m-auto">
                        <a href=""
                            class="btn btn-repeat bg-blue-2 color-black font-weight-bold mr-2 opacity-50">Ulangi</a>
                        <a href="{{ url('student/subject/' . $subjectId . '/course/' . $courseId . '/topic/' . $topic['id']) }}"
                            class="btn bg-blue-2 text-white font-weight-bold">Selesai</a>
                    </div>
                </div>
            </div>
        </div>
