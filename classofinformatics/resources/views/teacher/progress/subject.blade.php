    ...
    <div class="block-header">
        <div class="row clearfix mb-4">
            <div class="col-md-6 col-sm-12">
                <a href="{{ route('teacher.progress-siswa') }}" class="text-dark"><i
                ...
                html += `
                    <div class="mt-3">
                        <a href="{{ url('progress/subject/${subject.id}/course/${course.id}') }}" class="d-flex align-items-center p-2 w-100 bg-white shadow-sm rounded border-hover">
                            ...
                            <div class="ml-3">
                            <p class="text-dark text-uppercase text-dark pt-3">${subject.name} Semester ${course.semester} | ${course.description}</p>
                            </div>
                        </a>
                    </div>
                    `
