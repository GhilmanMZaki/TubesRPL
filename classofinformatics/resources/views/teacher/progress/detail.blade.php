                ...
                <nav aria-label="breadcrumb" class="mt-2">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a
                                href="{{ route('teacher.progress.subject.course', ['subject_id' => $subject['id'], 'course_id' => $course['id']]) }}">List
                                Bab</a></li>
                    ...
                    <div class="tab-content mt-0">
                        ...
                        <div class="tab-pane" id="exam">
                            <div class="table-responsive">
                                <table class="table table-hover table-custom spacing8">
                                    @if ($exams)
                                        <a href="{{ route('sendNotif', ['activity_id' => $exams[0]['activity_id']]) }}"
                                            class="btn bg-blue-2 text-white my-3 float-left text-capitalize"><i
                                                class="fa fa-upload mr-2"></i>Bagikan Nilai</a>
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Nama</th>
