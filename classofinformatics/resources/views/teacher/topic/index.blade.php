    ...
    <div class="block-header">
        <div class="row clearfix mb-4">
            <div class="col-md-6 col-sm-12">
                <a href="{{ url('/subject/' . $subject['id'] . '/course/' . $course['id']) }}" class="text-dark"><i
                        class="icon-arrow-left text-dark mr-2"></i>Kembali</a>
                <nav aria-label="breadcrumb" class="mt-4">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a
                                href="{{ url('/subject/' . $subject['id'] . '/course/' . $course['id']) }}">List Bab</a>
                        </li>
        ...
        <h5 class="color-blue-2 font-weight-bold text-uppercase">{{ $subject['name'] }} | {{ $course['description'] }} |
            {{ $topic['name'] }}</h5>
        <div class="alert alert-primary my-4 rounded" role="alert">
            <div class="d-flex align-items-center">
                ...
                Guru dapat mengubah dan menambahkan materi pembelajaran dan ujian.
            </div>
        </div>
        <div class="py-3">
            ...
            <div class="" id="loading-contents" style="display: none;">
                <div class="d-flex justify-content-between mt-3 align-items-end font-weight-bold">
                    ...
                    <a href="javascript::void(0)" class="color-blue-2">... <i
                            class="fa fa-chevron-right color-blue-2 font-12"></i></a>
                </div>
                <div class="mt-3">
                    <a href="javascript::void(0)"
                        ...
                        <div class="d-flex align-items-center justify-content-center w35 bg-blue-2 rounded-circle cursor-pointer ml-2"
                            data-toggle="tooltip" data-placement="top" title="materi"><i
                                class="icon-book-open text-white"></i></div>
                        <div class="ml-3">
            ...
            <div class="mt-3 pl-3">
                <a href="#" class="mt-3 color-blue-2" data-toggle="modal" data-target="#modal-add-content">+ Tambah
                    Ulasan</a>
            </div>
        </div>
        <div class="py-3">
...
@section('script')
    <script>
        ...
        function renderActivity(data) {
            ...
            htmlExamMain = `
            <h5 class="color-blue-2 font-weight-bold text-capitalize">daftar Ujian</h5>
            <a class="color-black font-weight-bold">Terdapat <span class="color-blue-2">${data.total_exam}</span> Ujian!</a>
                ${htmlExam}
            <div class="mt-3 pl-3">
                <a href="javascript:void(0)" class="mt-3 color-blue-2" data-toggle="modal" data-target="#modal-add-exam">+ Tambah Ujian</a>
            </div>
        `
            ...
            if (name === '') {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        resetValue()
                        getActivity()
                        swal('Berhasil menambahkan Ujian!')
                    },
                    error: function(e) {
                        button.html('Tambah')
                        swal('Gagal menambah Ujian. Silahkan coba lagi!')
                    }
                });
            }
        }
